...
<!--add the log out button here -->
	...
	<div class="container">
			<div align="center"><h1><span class="label label-danger">Welcome to Admin Page</span></h1></div>
		<div class="col-lg-12">
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h3><a href="add.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add File</a></h3>         <p align="right">
