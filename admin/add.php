	...
	<div class="container">
		...
		?>
			...
			<form method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="col-sm-6">
				<input type="text" name="fname" class="form-control" placeholder="enter LakeName" />
				</div>
				</div>
				...
				<div class="col-sm-6">
				<input type="text" name="lname" class="form-control" placeholder="Comments" />
				</div>
				</div>

								<div class="form-group">
				<label class="col-sm-3 control-label">Rate Lake (1-100)</label>
				<div class="col-sm-6">
				<input type="text" name="age" class="form-control" placeholder="enter rating #" />
				</div>
				</div>
