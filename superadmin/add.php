	...
	try
	{
		...
		if(!isset($errorMsg))
		{
			...
			if($insert_stmt->execute())
			{
				...
				header("refresh:3;http://joebrenny.com/final_project/superadmin/index.php"); //refresh 3 second and redirect to index.php page
	...
	<div class="container">
		...
		?>
			...
			<form method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="form-group">
				<label class="col-sm-3 control-label">Comments on Lake</label>
				<div class="col-sm-6">
				<input type="text" name="lname" class="form-control" placeholder="Let everyone know speical comments about lake" />
				</div>
				</div>

								<div class="form-group">
				<label class="col-sm-3 control-label">Rate boat launch</label>
				<div class="col-sm-6">
				<input type="text" name="age" class="form-control" placeholder="Enter Rating (1-100)" />
				</div>
				</div>


				<div class="form-group">
				<label class="col-sm-3 control-label">Lake Image or Boat Launch Image</label>
				<div class="col-sm-6">
